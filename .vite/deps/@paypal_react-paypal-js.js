...
function destroySDKScript(reactPayPalScriptID) {
  var scriptNode = self.document.querySelector(
    "script[".concat(SCRIPT_ID, '="').concat(reactPayPalScriptID, '"]')
  );
  if (
...
function usePayPalScriptReducer() {
  var scriptContext = validateReducer(
    (0, import_react.useContext)(ScriptContext)
  );
...
function useScriptProviderContext() {
  var scriptContext = validateBraintreeAuthorizationData(
    validateReducer((0, import_react.useContext)(ScriptContext))
  );
...
var PayPalButtons = function (_a) {
  ...
  var _e = usePayPalScriptReducer()[0],
    ...
    options = _e.options;
  var _f = (0, import_react.useState)(null),
    initActions = _f[0],
    setInitActions = _f[1];
  var _g = (0, import_react.useState)(true),
    isEligible = _g[0],
    setIsEligible = _g[1];
  var _h = (0, import_react.useState)(null),
    setErrorState = _h[1];
  ...
  (0, import_react.useEffect)(function () {
    ...
    if (
      paypalWindowNamespace === void 0 ||
      paypalWindowNamespace.Buttons === void 0
    ) {
    ...
    buttons.current.render(buttonsContainerRef.current).catch(function (err) {
      ...
      setErrorState(function () {
        throw new Error(
          "Failed to render <PayPalButtons /> component. ".concat(err)
        );
      });
    });
    return closeButtonsComponent;
    ...
    [buttonProps.fundingSource, buttonMessageContent],
    false
  ));
...
function loadScript(options, PromisePonyfill) {
  ...
  return loadCustomScript(
    ...
    throw new Error(
      "The window.".concat(namespace, " global variable is not available.")
    );
  });
}
...
var BraintreePayPalButtons = function (_a) {
  ...
  var _e = (0, import_react.useState)(null),
    setErrorState = _e[1];
...
var PayPalMarks = function (_a) {
  ...
  var _d = (0, import_react.useState)(true),
    isEligible = _d[0],
    setIsEligible = _d[1];
  var _e = (0, import_react.useState)(null),
    setErrorState = _e[1];
  ...
  (0, import_react.useEffect)(
    function () {
      ...
      if (
        paypalWindowNamespace === void 0 ||
        paypalWindowNamespace.Marks === void 0
      ) {
        return setErrorState(function () {
          throw new Error(
            generateErrorMessage({
...
var PayPalMessages = function (_a) {
  ...
  (0, import_react.useEffect)(function () {
    ...
    if (
      paypalWindowNamespace === void 0 ||
      paypalWindowNamespace.Messages === void 0
    ) {
      return setErrorState(function () {
        throw new Error(
          generateErrorMessage({
    ...
    messages.current.render(messagesContainerRef.current).catch(function (err) {
      ...
      setErrorState(function () {
        throw new Error(
          "Failed to render <PayPalMessages /> component. ".concat(err)
        );
      });
    });
  }, __spreadArray([isResolved], forceReRender, true));
...
var PayPalHostedFieldsProvider = function (_a) {
  ...
  var _c = (0, import_react.useState)(true),
    isEligible = _c[0],
    setIsEligible = _c[1];
  var _d = (0, import_react.useState)(),
    cardFields = _d[0],
    setCardFields = _d[1];
  var _e = (0, import_react.useState)(null),
    setErrorState = _e[1];
      ...
      if (!hostedFields.current) {
        throw new Error(
          generateMissingHostedFieldsError(
            ...
            (_a2[SDK_SETTINGS.DATA_NAMESPACE] =
              options[SDK_SETTINGS.DATA_NAMESPACE]),
            _a2)
          )
        );
...
var PayPalHostedField = function (_a) {
  ...
  var hostedFieldContext = (0, import_react.useContext)(
    PayPalHostedFieldsContext
  );
  (0, import_react.useEffect)(function () {
    var _a2;
    if (
      !(hostedFieldContext === null || hostedFieldContext === void 0
        ? void 0
...
var usePayPalCardFieldsRegistry = function () {
  var _a = (0, import_react.useState)(null),
    setError = _a[1];
...
var PayPalCardFieldsProvider = function (_a) {
  ...
  var _d = (0, import_react.useState)(null),
    cardFieldsForm = _d[0],
    setCardFieldsForm = _d[1];
  var cardFieldsInstance = (0, import_react.useRef)(null);
  var _e = (0, import_react.useState)(false),
    isEligible = _e[0],
    setIsEligible = _e[1];
  var _f = (0, import_react.useState)(null),
    setError = _f[1];
    ...
    function () {
      ...
      try {
        cardFieldsInstance.current =
          (_c2 =
            (_b2 = (_a2 = getPayPalWindowNamespace$1(
              options[SDK_SETTINGS.DATA_NAMESPACE]
            )).CardFields) === null || _b2 === void 0
              ? void 0
              : _b2.call(_a2, __assign({}, props))) !== null && _c2 !== void 0
            ? _c2
            : null;
      } catch (error) {
        setError(function () {
        ...
        setError(function () {
          ...
          throw new Error(
            generateMissingCardFieldsError(
              ...
              (_a3[SDK_SETTINGS.DATA_NAMESPACE] =
                options[SDK_SETTINGS.DATA_NAMESPACE]),
              _a3)
            )
          );
...
var PayPalCardField = function (_a) {
  ...
  var _c = (0, import_react.useState)(null),
    setError = _c[1];
  ...
  (0, import_react.useEffect)(function () {
    ...
    registeredField === null || registeredField === void 0
      ? void 0
      : registeredField.render(containerRef.current).catch(function (err) {
